...
4. For personal thoughts, feelings, reflections, gratitude, or anything about how the day feels → ALWAYS update today's Daily Log (REFLECTIONS section). NEVER create a separate Personal note. Use Rule 13 to find or create today's log. Strong signal: if the message uses "I" or "me" and is about feelings, experiences, or the day → it belongs in the Daily Log REFLECTIONS section.
