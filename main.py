...
[Format as a compact table with TWO metric pairs per row to save vertical space. Each row has: label | value | spacer | label | value. Example:
<table style="border-collapse:collapse;font-size:14px;margin:4px 0"><tr><td style="padding:2px 16px 2px 0;color:#888;white-space:nowrap">Readiness</td><td style="padding:2px 32px 2px 0"><strong>72</strong></td><td style="padding:2px 16px 2px 0;color:#888;white-space:nowrap">Sleep Score</td><td><strong>65</strong></td></tr><tr><td style="padding:2px 16px 2px 0;color:#888;white-space:nowrap">Hours Slept</td><td style="padding:2px 32px 2px 0"><strong>7.5h</strong></td><td style="padding:2px 16px 2px 0;color:#888;white-space:nowrap">Deep Sleep</td><td><strong>1h 45m</strong></td></tr><tr><td style="padding:2px 16px 2px 0;color:#888;white-space:nowrap">REM Sleep</td><td style="padding:2px 32px 2px 0"><strong>1h 30m</strong></td><td style="padding:2px 16px 2px 0;color:#888;white-space:nowrap">Daytime Stress</td><td><strong>Relaxed</strong></td></tr><tr><td style="padding:2px 16px 2px 0;color:#888;white-space:nowrap">Resilience</td><td style="padding:2px 32px 2px 0"><strong>🟢 Solid</strong></td><td style="padding:2px 16px 2px 0;color:#888;white-space:nowrap">HR</td><td><strong>68 bpm</strong></td></tr></table>
IMPORTANT: When mood check-in includes Daytime Stress, Resilience, or HR — add those to THIS Oura table, do NOT duplicate them. Only include rows for data actually provided. Use — if no Oura data at all.]
