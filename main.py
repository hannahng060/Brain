...
[ONLY written from the morning sleep check-in. Format as a compact table with TWO metric pairs per row. Example:
<table style="border-collapse:collapse;font-size:14px;margin:4px 0"><tr><td style="padding:2px 16px 2px 0;color:#888;white-space:nowrap">Readiness</td><td style="padding:2px 32px 2px 0"><strong>72</strong></td><td style="padding:2px 16px 2px 0;color:#888;white-space:nowrap">Sleep Score</td><td><strong>65</strong></td></tr><tr><td style="padding:2px 16px 2px 0;color:#888;white-space:nowrap">Hours Slept</td><td style="padding:2px 32px 2px 0"><strong>7.5h</strong></td><td style="padding:2px 16px 2px 0;color:#888;white-space:nowrap">Deep Sleep</td><td><strong>1h 45m</strong></td></tr><tr><td style="padding:2px 16px 2px 0;color:#888;white-space:nowrap">REM Sleep</td><td style="padding:2px 32px 2px 0"><strong>1h 30m</strong></td><td></td><td></td></tr></table>
...
OR combine mood + energy + stress + resilience + HR in one table if logged together (preferred when all data present):
<table style="border-collapse:collapse;font-size:14px;margin:4px 0"><tr><td style="padding:2px 20px 2px 0;color:#888;white-space:nowrap">Time</td><td style="padding:2px 20px 2px 0;color:#888">Mood</td><td style="padding:2px 20px 2px 0;color:#888">Energy</td><td style="padding:2px 20px 2px 0;color:#888">Stress</td><td style="padding:2px 20px 2px 0;color:#888">Resilience</td><td style="color:#888">HR</td></tr><tr><td style="padding:2px 20px 2px 0;white-space:nowrap">9:30 AM</td><td style="padding:2px 20px 2px 0"><strong>😊 Happy</strong></td><td style="padding:2px 20px 2px 0"><strong>4/5</strong></td><td style="padding:2px 20px 2px 0"><strong>Relaxed</strong></td><td style="padding:2px 20px 2px 0"><strong>🟢 Solid</strong></td><td><strong>66 bpm</strong></td></tr></table>
Only include columns for data that was actually logged. Daytime Stress, Resilience, and HR always go HERE — never in OURA RING METRICS.]
